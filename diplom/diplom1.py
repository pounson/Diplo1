...
class VkAPI:
    ...
    def __init__(self):
        self.token = '1159c8d3dc818205861288d97ebb9963a0f915f0bba07f6f2d5ef20f93f358de9ef91a1fd4264f84e6ef7'
        self.version = '5.124'

    def get_photos(self, uid, qty=5):
        get_url = urljoin(self.Base_url, 'photos.get')
        resp = requests.get(get_url, params={'access_token': self.token,'v': self.version,'owner_id': uid,'album_id': 'profile','photo_sizes': 1,'extended': 1}).json().get('response').get('items')
